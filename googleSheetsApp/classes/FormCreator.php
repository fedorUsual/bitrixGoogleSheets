...
class FormCreator
{
    ...
    private function setFields()
    {
        ...
        $this->fields = array_merge($this->fields, $userFields);
    }
                                ...
                                <div class="control" style="width: 203px">
                                    <div class="select">
                                        <select id="entity_select" name="entity_type">
                                            ...
                                            foreach (self::$availibleEntities as $typeName) {
                                                $selected = '';
                                                if (!empty(self::$entityType) && self::$entityType == $typeName) {
                                                    $selected = 'selected';
                                                }
                                                ?><option value="<?=$typeName?>" <?=$selected?>><?=$typeName?></option><?php
                                            }
                                            ?></select>
                                    </div>
                                </div>
